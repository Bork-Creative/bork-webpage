...
- **Account Information:** If you choose to link your game account with external services such as Google Play Games or Apple Game Center, we may receive basic profile information (e.g., unique user ID, display name) to manage and sync your progress.

_**b. Analytics and Performance Data**_  
- **Usage Data:** We collect standard analytics data (via Unity Gaming Services Analytics) that may include information about your device (e.g., device type, OS version, screen resolution) and how you interact with the Game. This helps us optimize performance and improve your experience.
- **Technical Data:** Error reports, crash logs, and other diagnostic data are also collected to troubleshoot issues and improve overall stability.
...
- **Improvement & Analytics:** To monitor and analyze game performance, usage patterns, and technical issues to enhance gameplay and user experience.  
...
- **Contractual Necessity:** To perform services you have requested, such as storing your game progress or enabling account linking.  
- **Legitimate Interests:** To improve our game, ensure security, and communicate with you regarding updates and support, provided these interests are not overridden by your rights.
...
- **Right to Restrict Processing / Object:** You may have the right to restrict or object to certain processing activities.  
- **Right to Data Portability:** You may request to receive your personal data in a structured, commonly used format.
- **CCPA-Specific Rights (for California residents):** Such as the right to know about the personal information we collect, the right to request deletion, and the right to opt out of the sale of your personal information.
